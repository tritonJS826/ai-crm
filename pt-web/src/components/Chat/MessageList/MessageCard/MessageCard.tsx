...
import styles from "src/components/Chat/MessageList/MessageCard/MessageCard.module.scss";
...
export function MessageCard({message, contactName, own = true}: MessageCardProps) {

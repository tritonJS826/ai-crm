...
api_router.include_router(
    conversations.router, prefix="/br-general/conversations", tags=["conversations"]
)

# Products Catalog
api_router.include_router(
    products.router, prefix="/br-general/products", tags=["products"]
)

# Checkout (Stripe redirect)
api_router.include_router(checkout.router, prefix="/br-general/stripe", tags=["stripe"])

# Webhooks (Meta + Stripe)
api_router.include_router(
    webhooks.router, prefix="/br-general/webhooks", tags=["webhooks"]
)

# AI Drafting
api_router.include_router(ai.router, prefix="/br-general/ai", tags=["ai"])
...
api_router.include_router(ready.router, prefix="/br-general", tags=["ready"])
